...
public class Payment_Details extends JFrame{ //Fifth
	...
	Fcode.setFont(new Font("SERIF", Font.PLAIN, 17));
	...
	Cardno.setFont(new Font("SERIF", Font.PLAIN, 13));
	Cardno.setBounds(602, 299, 101, 19);
	add(Cardno);
		
	JLabel Phoneno = new JLabel("PHONE_NO");
	Phoneno.setFont(new Font("SERIF", Font.PLAIN, 13));
